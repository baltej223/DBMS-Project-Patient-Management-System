# Patient Management System (DBMS Project)

This repository contains a comprehensive **Patient Management System** built as part of the **UCS310 – Database Management Systems** course. It focuses on advanced PostgreSQL features like Row-Level Security (RLS), PL/SQL Procedures, and Cryptographic Integrity.

---

## 🚀 Quick Links
- **[Detailed Project Report](./DBMS_PROJECT_REPORT.md)**
- **[Novelty Features](./NOVELTY_FEATURES.md)**
- **[SQL/PLSQL Implementation](./backend/prisma/dbms_implementation.sql)**
